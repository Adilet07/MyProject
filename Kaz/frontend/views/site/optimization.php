                ...
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="social-share">
                            ...
                            <ul class="navbar-nav text-center pull-right">
                              <li><a href="#" class="icon fa-comment">16</a></li>
                              <li><a href="#" class="icon fa-heart">32</a></li>
                              <li><a class="s-facebook" href="#"><i class="fa fa-eye"></i>325</a></li>
                            </ul>
                        </div>
                    </div>
                </article>
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="social-share">
                            ...
                            <ul class="navbar-nav text-center pull-right">
                              <li><a href="#" class="icon fa-comment">17</a></li>
                              <li><a href="#" class="icon fa-heart">30</a></li>
                              <li><a class="s-facebook" href="#"><i class="fa fa-eye"></i>320</a></li>
                            </ul>
                        </div>
                    </div>
                </article>
